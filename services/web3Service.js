...
export const getAllTransactionInSmartContract = async (useFor, event) => {
  ...
  const response = events.map((event) => {
    ...
    return {
      walletId: returnValues.walletId.toString(),
      ownerId: returnValues.ownerId,
      amount: returnValues.amount.toString(),
      hash: returnValues.hash,
      transactionType: returnValues.transactionType,
      meta: returnValues.meta,
